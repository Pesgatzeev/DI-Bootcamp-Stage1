...
// const sentence = "This restaurant is not bad. I like it!";
// console.log(sentence.indexOf('not'));
// const wordNot=sentence[19][0];
// console.log(wordNot);
// console.log(sentence.indexOf('bad'));
// const wordBad=sentence[23][0];
// console.log(wordBad);
// if (wordNot > wordBad){
// console.log("This restaurant is good. I like it!");
// } else{ 
//   console.log("This restaurant is not bad. I like it!");
// }