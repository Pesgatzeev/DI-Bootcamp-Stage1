...
// let numbers = [122, 8400, 100053, 333333333, 8];
...
//   console.log(`Hi, my name is ${studentName} and I am from ${guestList[studentName]}`);
// } else{
...
// let age = [20,5,12,43,98,55];
// let maxnNumber = age[0];
// for(i=1; i<age.length; i++){
//   if(age[i] > maxnNumber){
//     maxnNumber = age[i]
//   }
// }
// console.log(maxnNumber);